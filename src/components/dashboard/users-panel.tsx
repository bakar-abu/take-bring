    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <button
          ...
          disabled={pending}
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-logo-bg px-4 py-2.5 text-sm font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-60"
        >
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="Admins" value={String(roleCounts.Admin)} />
        <MetricCard
          label="Content managers"
          value={String(roleCounts["Content Manager"])}
        />
        <MetricCard label="Viewers" value={String(roleCounts.Viewer)} />
      </div>

      <UsersDataGrid users={users} onDeleteUser={handleDelete} />
